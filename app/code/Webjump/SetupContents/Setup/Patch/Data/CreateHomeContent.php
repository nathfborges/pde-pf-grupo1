...
class CreateHomeContent implements DataPatchInterface {
    ...
    public function apply(): void
    {
        ...
        $content = <<<HTML
                ...
                <div data-content-type="block" data-appearance="default" data-element="main">{{widget type="Magento\Cms\Block\Widget\Block" template="widget/static_block/default.phtml" block_id="2" type_name="CMS Static Block"}}</div>
        HTML;
