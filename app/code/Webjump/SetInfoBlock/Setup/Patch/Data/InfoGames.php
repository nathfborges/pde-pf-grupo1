...
class InfoGames implements DataPatchInterface
{
    ...
    public function apply(): void
    {
        ...
        $content = <<<HTML
        <div data-content-type="html" data-appearance="default" data-element="main">&lt;div class="parcel-block"&gt;&lt;p class="title-parcel-block"&gt;Você pode &lt;strong&gt;parcelar&lt;/strong&gt;&lt;/p&gt;&lt;p class="text-parcel-block"&gt;em até 12x sem juros!&lt;/p&gt;&lt;/div&gt;
        </div>
        </div>
        HTML;
