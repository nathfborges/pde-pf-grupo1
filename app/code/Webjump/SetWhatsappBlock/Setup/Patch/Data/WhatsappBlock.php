 ...
 * @codeCoverageIgnore
 */
class WhatsappBlock implements DataPatchInterface
{
    /**
     * @var string IDENTIFIER
     */
    const IDENTIFIER = 'botao-whatsapp';
    
    /**
     * @var string TITLE
     */
    const TITLE = 'Whatsapp Button';
    ...
    public function apply(): void
    {
        ...
        $content = <<<HTML
        <div data-content-type="html" data-appearance="default" data-element="main">&lt;a class="whatsapp" target="_blank" href="https://api.whatsapp.com/send?phone=0"&gt;
    ...
    private function getCmsBlock($content): \Magento\Cms\Api\Data\BlockInterface
    {
        ...
        return $this->blockFactory->create()
            ...
            ->setStores([$games_store_id, $skate_store_id, $skateIng_store_id])
            ->setContent($content);
    }
