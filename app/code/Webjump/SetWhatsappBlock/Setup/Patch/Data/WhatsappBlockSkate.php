 ...
 * @codeCoverageIgnore
 */
class WhatsappBlockSkate implements DataPatchInterface
{
    /**
     * @var string IDENTIFIER
     */
    const IDENTIFIER = 'botao-whatsapp-pt';
    
    /**
     * @var string TITLE
     */
    const TITLE = 'Whatsapp Button Pt';
    ...
    public function apply(): void
    {
        ...
        $content = <<<HTML
        <div data-content-type="html" data-appearance="default" data-element="main">&lt;a class="whatsapp" target="_blank" href="https://api.whatsapp.com/send?phone=IBC%20Skate&text=Ol%C3%A1,%20gostaria%20de%20conversar%20com%20algum%20atendente%20da%20IBC%20Skate."&gt;
    ...
    private function getCmsBlock($content): \Magento\Cms\Api\Data\BlockInterface
    {
        ...
        $skate_store_id = $this->storeRepositoryInterface->get(ConfigureStores::IBC_SKATE_STORE_1_CODE)->getId();

        return $this->blockFactory->create()
            ->setTitle(self::TITLE)
            ->setIdentifier(self::IDENTIFIER)
            ->setIsActive(\Magento\Cms\Model\Block::STATUS_ENABLED)
            ->setStores([$skate_store_id])
            ->setContent($content);
    }
